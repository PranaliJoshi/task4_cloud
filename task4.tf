...
resource "aws_instance" "wordpress"{
 ...
 ami = "ami-08706cb5f68222d09"
  ...
  connection {
    type     = "ssh"
    user     = "ec2-user"
    private_key = file("C:/Users/pranali/Downloads/keycloudclass.pem")
  ...
  provisioner "remote-exec" {
    inline = [
      ...
      "sudo docker run -dit -e WORDPRESS_DB_HOST=${aws_instance.mysql.private_ip}:8080 -e WORDPRESS_DB_USER=pranali -e WORDPRESS_DB_PASSWORD=***** -e WORDPRESS_DB_NAME=data -p 8000:80 --name mywp wordpress:5.1.1-php7.3-apache"
    ]
  }
  tags = {
    Name = "wordpress1"
